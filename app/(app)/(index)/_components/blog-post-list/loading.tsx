...
export function BlogPostListLoading({
	...
	return (
		<ul className={clsx(css.blogPostListLoading, className)} {...props}>
			<BlogPostListLoadingItem data-testid="blog-post-loading" />
...
function BlogPostListLoadingItem({
	...
	return (
		<li className={clsx(css.blogPostListLoadingItem, className)} {...props}>
			...
			<div className={css.title} data-testid="title-loading">
				<LoadingPlaceholderText
					sampleText={
						titleSample ||
			...
			<div className={css.brief} data-testid="brief-loading">
				<LoadingPlaceholderText
					sampleText={
						briefSample ||
