...
Admin UI Surface is a project prohibition: do not review files under `app/(payload)/` per [code-review-guideline › scoping](../code-review-guideline/scoping.md). Payload owns that route segment.
