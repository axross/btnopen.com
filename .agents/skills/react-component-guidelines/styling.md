...
- Instead, those styles MUST be set at the parent component and passed via the `className` prop to the component.
- Other styles MUST be defined within the component's CSS Module.
