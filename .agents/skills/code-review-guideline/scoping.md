...
Repository-Specific Boundaries is a project prohibition: do not review files under `app/(payload)/` — they are generated/managed by Payload CMS upgrades. See [Development Guidelines › change-management](../development-guidelines/change-management.md).
