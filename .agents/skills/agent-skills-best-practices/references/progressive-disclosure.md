...
- changing payload schemas or URL decoding
- tracing untrusted bridge payload fields into metadata, UI, and links
- checking source URL protocol filtering and 1024-character limits
```
