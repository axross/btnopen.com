...
External links in bridge payloads can become clickable UI, so validation is a protocol allowlist:
...
> Custom protocols are reserved for Obsidian launch URLs generated by local helpers.
...
> MUST run npm test after changing validation helpers.
