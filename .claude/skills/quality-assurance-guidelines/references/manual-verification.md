...
Apply these rules to verify the author exercised the change in the dev server before relying on the e2e suite. Manual verification is the **first line** of confirmation per the project's development guidelines (verification rules).
