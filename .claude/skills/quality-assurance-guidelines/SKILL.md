...
when_to_use: Use when reviewing whether a change has adequate verification evidence — "are tests good", "did this break anything", "is the scenario catalog complete", or "should I bump snapshots". Not for how to write the tests — use e2e-testing-guidelines (Playwright) or unit-test-guidelines (Jest).
