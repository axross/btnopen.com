...
| `logger.error()` used instead of `captureException()` where the project requires error-tracker reporting | Major |
| Magic value introduced where a CSS variable or named constant already exists | Minor |
