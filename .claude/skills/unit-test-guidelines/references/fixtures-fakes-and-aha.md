...
Large framework- or library-owned objects, such as Payload request objects, are wide boundaries. Unit tests should fake the smallest part of the boundary the unit actually calls.
