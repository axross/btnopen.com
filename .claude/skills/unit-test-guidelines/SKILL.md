...
- adding, renaming, regrouping, or reviewing `describe(...)` and `it(...)` blocks
...
- avoiding tests that overfit private helpers, dependency internals, render-prop mechanics, or call shapes
