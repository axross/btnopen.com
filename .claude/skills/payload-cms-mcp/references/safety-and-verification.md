...
- MUST NOT duplicate this handback rule elsewhere: an `outline` / `authoringNotes` write hands back the agentic view URL instead, per the blog-post authoring guidelines' authoring-artifacts reference.
