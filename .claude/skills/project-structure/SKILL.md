...
when_to_use: Use when locating files, placing modules, checking repository structure, or needing stack/service context. Not for design/abstraction quality (the maintainable code guidelines) or route-path conventions (the routing guidelines).
