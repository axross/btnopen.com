...
Apply this reference when creating or extending the project's archetype skills — a structure skill, a component skill, and a UI/design skill; in this repository, the project's project-structure skill, React component guidelines, and UI design principles — or when auditing whether an existing project skill covers the topics its archetype expects.
